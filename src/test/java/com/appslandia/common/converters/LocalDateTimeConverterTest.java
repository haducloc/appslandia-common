...
public class LocalDateTimeConverterTest {
  ...
  public void test_HHmm() {
    ...
    FormatProvider formatProvider = new FormatProviderImpl(Language.EN_US);
    try {
      var v = converter.parse("2010-10-10T09:30", formatProvider);
      Assertions.assertNotNull(v);

      Assertions.assertEquals("10/10/2010 09:30:00.000", converter.format(v, formatProvider, true));
      Assertions.assertEquals("2010-10-10T09:30:00.000", converter.format(v, formatProvider, false));
