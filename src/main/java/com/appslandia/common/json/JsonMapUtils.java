...
public class JsonMapUtils {
  ...
  public static <E extends Enum<E>> E getEnum(Map<String, Object> jsonMap, String key, Class<E> type) {
    var value = jsonMap.get(key);
    if (value == null) {
      return null;
    }
    ...
    if (value instanceof String str) {
      try {
        ...
        throw new JsonValueException(STR.fmt("Failed to getEnum('{}')", key), ex);
      }
    }

    throw new JsonValueException(STR.fmt("Failed to getEnum('{}')", key));
  }
}
